...
App offline para comissários de quadra conferirem a soma dos pontos
funcionais das equipes em jogos de basquetebol em cadeira de rodas.
Adaptado pela CBBC (Confederação Brasileira de Basquetebol em Cadeira
de Rodas) a partir do projeto IWBF Team Points Control.
...
- Aceita **planilha .xlsx ou PDF** (texto extraível) com colunas:
  `clube, classe, atleta, camisa, data de nascimento, genero`.
...
5. No terminal do Codespace:
   ...
   essa URL pra testar no navegador (celular ou desktop). Funciona
...
- `lib/widgets/` — logo header, jersey icon.
...
| clube           | classe | atleta              | camisa | data de nascimento | genero |
| --------------- | ------ | ------------------- | ------ | ------------------ | ------ |
| ADD Vitória     | 4,5    | João Silva          | 10     | 15/04/1995         | M      |
| Cruzeiro CR     | 1,0    | Mariana Ribeiro     | 4      | 22/09/2002         | F      |
